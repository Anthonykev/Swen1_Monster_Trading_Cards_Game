...
using Monster_Traiding_Cards.Model;

using Thread = Monster_Traiding_Cards.Model.Thread;
...
namespace Monster_Traiding_Cards.Repositories
{
    ...
    public class EntryRepository : Repository<Entry>, IRepository<Entry>
    {
        ...
        {
            _TableName = "ENTRIES";
            _Fields = new string[] { "ID", "TEXT", "TIME", "KTHREAD", "OWNER" };
            _Params = new string[] { ":id", ":txt", ":tim", ":thr", ":own" };
        }
